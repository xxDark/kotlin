...
fun test() {
    <!INAPPLICABLE_CANDIDATE!>unitCoercion<!>(<!UNRESOLVED_REFERENCE!>::foo<!>)
    <!INAPPLICABLE_CANDIDATE!>defaults<!>(<!UNRESOLVED_REFERENCE!>::bar<!>)
    <!INAPPLICABLE_CANDIDATE!>varargs<!>(<!UNRESOLVED_REFERENCE!>::baz<!>)
    <!INAPPLICABLE_CANDIDATE!>unitCoercionAndDefaults<!>(<!UNRESOLVED_REFERENCE!>::all<!>)
}
