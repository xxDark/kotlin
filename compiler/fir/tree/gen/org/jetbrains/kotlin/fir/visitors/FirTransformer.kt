...
abstract class FirTransformer<in D> : FirVisitor<CompositeTransformResult<FirElement>, D>() {
    ...
    open fun transformAnnotatedDeclaration(annotatedDeclaration: FirAnnotatedDeclaration, data: D): CompositeTransformResult<FirDeclaration> {
    ...
    open fun transformContractFunction(contractFunction: FirContractFunction, data: D): CompositeTransformResult<FirDeclaration> {
    ...
    final override fun visitAnnotatedDeclaration(annotatedDeclaration: FirAnnotatedDeclaration, data: D): CompositeTransformResult<FirDeclaration> {
    ...
    final override fun visitContractFunction(contractFunction: FirContractFunction, data: D): CompositeTransformResult<FirDeclaration> {
